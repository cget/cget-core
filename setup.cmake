...
macro(CGET_GET_CONFIG name var default datatype desc)
  if("${${var}}" STREQUAL "")
    ...
    CGET_MESSAGE(2 "Using setting ${var} from user config: ${${var}}")
  endif()
endmacro()

SET(CGET_CONFIG_SHARED_BIN_DIR_DEFAULT "OFF")
IF(DEFINED ENV{HOME})
        STRING(REPLACE "\\" "/" CGET_CONFIG_SHARED_BIN_DIR_DEFAULT "$ENV{HOME}/.cget-bin")  
...
SET(CGET_MAJOR_VERSION 1)
SET(CGET_MINOR_VERSION 1)
SET(CGET_PATCH_VERSION 0)
...
STRING(REPLACE " " "_" CGET_C_COMPILER_ID_NO_SPACES "${CMAKE_C_COMPILER_ID}")
STRING(REPLACE " " "_" CGET_CMAKE_GENERATOR_NO_SPACES "${CMAKE_GENERATOR}")

SET(CGET_CONFIGURATION_SUFFIX "${CGET_CMAKE_GENERATOR_NO_SPACES}/${CGET_C_COMPILER_ID_NO_SPACES}")
if(NOT "${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "${CMAKE_HOST_SYSTEM_PROCESSOR}")
  IF("${CMAKE_SYSTEM_PROCESSOR}" STREQUAL "")
    message(FATAL_ERROR "Error: CMAKE_SYSTEM_PROCESSOR is empty; it must be defined in your toolchain file ('${CMAKE_TOOLCHAIN_FILE}'). See https://cmake.org/cmake/help/v3.1/variable/CMAKE_SYSTEM_PROCESSOR.html")
  endif()

  SET(CGET_CONFIGURATION_SUFFIX "${CGET_CONFIGURATION_SUFFIX}/${CMAKE_SYSTEM_NAME}/${CMAKE_SYSTEM_PROCESSOR}")
endif()

SET(CGET_INSTALL_DIR ${CGET_BIN_DIR}install_root/${CGET_CONFIGURATION_SUFFIX})
