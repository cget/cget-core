...
IF( "${CMAKE_TOOLCHAIN_FILE}" STREQUAL "")
  SET(CGET_PLATFORM_DESCRIPTOR "")
ELSE()
  get_filename_component(COMPILER "${CMAKE_C_COMPILER}" NAME_WE)
  SET(CGET_PLATFORM_DESCRIPTOR "/${CMAKE_SYSTEM_NAME}_${COMPILER}")
ENDIF()
SET(CGET_INSTALL_DIR ${CGET_BIN_DIR}/install_root${CGET_PLATFORM_DESCRIPTOR}/${CGET_CMAKE_GENERATOR_NO_SPACES})
