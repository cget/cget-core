...
CGET_GET_CONFIG(cget.sharedBinLocation CGET_CONFIG_SHARED_BIN_DIR "OFF" PATH "Use given directory to store all projects .cget-bin")
...
if (NOT CGET_BIN_DIR)
    if(CGET_CONFIG_SHARED_BIN_DIR)
        SET(CGET_BIN_DIR "${CGET_CONFIG_SHARED_BIN_DIR}/")
    else()
...
if (CGET_CONFIG_ORGANIZE_AS_SUBMODULES AND NOT EXISTS "${CGET_CORE_DIR}/.cget/.added")
