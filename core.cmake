...
macro(CGET_PARSE_OPTIONS name)
    ...
    if(CMAKE_CROSSCOMPILING)
        SET(Build_Dir_Prefix "${CMAKE_SYSTEM_NAME}-${CMAKE_SYSTEM_PROCESSOR}")
    endif()
    ...
    set(INSTALL_DIR "${CGET_INSTALL_DIR}/${name}/${REPO_DIR_SUFFIX}/${Build_Dir_Prefix}${Build_Hash}")

    set(BUILD_DIR "${REPO_DIR}/${Build_Dir_Prefix}${REL_BUILD_DIR}")
    if (DEFINED RELEASE_REL_BUILD_DIR)
        set(RELEASE_BUILD_DIR "${REPO_DIR}/${Build_Dir_Prefix}${RELEASE_REL_BUILD_DIR}")
    endif ()
