...
function(CGET_HAS_DEPENDENCY name)
    ...
    if(ARGS_ALLOW_SYSTEM)
        CGET_FIND_DEPENDENCY(${ARGS_FINDNAME} ${ARGS_CMAKE_VERSION} COMPONENTS ${ARG_COMPONENTS} QUIET ${ARGS_FIND_OPTIONS})
    ...
    if (NOT ARGS_NO_FIND_PACKAGE)
        ...
        CGET_FIND_DEPENDENCY(${ARGS_FINDNAME} ${ARGS_CMAKE_VERSION} REQUIRED ${ARGS_FIND_OPTIONS}  COMPONENTS ${ARG_COMPONENTS})
