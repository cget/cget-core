...
macro(CGET_REGISTER_INSTALL_DIR INSTALL_DIR)
  if (EXISTS ${INSTALL_DIR})
    if (NOT CGET_IS_SCRIPT_MODE)
      ...
      FILE(WRITE "${CMAKE_BINARY_DIR}/cget-env.cmake" "SET(CMAKE_FIND_ROOT_PATH \"${CMAKE_FIND_ROOT_PATH}\" CACHE INTERNAL \"\")")
      ...
      FILE(APPEND "${CMAKE_BINARY_DIR}/cget-env.cmake" "\nSET(CMAKE_LIBRARY_PATH \"${CMAKE_LIBRARY_PATH}\" CACHE INTERNAL \"\")")
...
if (CGET_IS_ROOT_DIR)
  ...
  CGET_EXECUTE_PROCESS(COMMAND ${CMAKE_COMMAND} -E remove "${CMAKE_BINARY_DIR}/cget-env.cmake")
...
function(CGET_DIRECT_GET_PACKAGE name)
    ...
    if (NOT EXISTS ${STAGING_DIR})
        ...
        elseif (ARGS_GIT)
            ...
            if (CGET_CONFIG_ORGANIZE_AS_SUBMODULES)
...
macro(CGET_HAS_DEPENDENCY name)
    ...
    if(NO_VERSION_SPECIFIED OR ARGS_SIMPLE_BUILD OR NOT BUILD_CACHE_VAL STREQUAL Build_Hash)
