...
macro(CGET_SIMPLE_BUILD name)
	file(GLOB_RECURSE CFILES "${REPO_DIR}/*.cc" "${REPO_DIR}/*.cpp" "${REPO_DIR}/*.c")
	file(GLOB_RECURSE HFILES RELATIVE "${REPO_DIR}" "${REPO_DIR}/*.h" "${REPO_DIR}/*.hpp")
	
	ADD_LIBRARY(${name} STATIC ${CFILES})
	CGET_MESSAGE(3 "Adding project ${name} with ${CFILES} ${HFILES}")
